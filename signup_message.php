...
<div id="navbar" class="topnav" >
    ...
    <a href="signup.php" class="active"><i class="fa-solid fa-user-plus"></i> Register</a>
    <a class="nav-link" href="#">Hello <b><i class="fa-solid fa-user"></i>User</b></a>
...
<div class="content ">
      ...
      <div class="container2">
        <h4 style="color:green;  text-shadow: 2px 1px black; text-align: center; "><u>REGISTRATION SUCCESSFUL</u></h4>
        <p style="color:blue; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; text-shadow: 2px 1px black; text-align: center;">A mail has been sent to your inbox to activate your account. 
            Please make sure to click on the link to activate your account .</p>
